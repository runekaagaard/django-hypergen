...
exports.post = exports.element = exports.read = exports.coerce = exports.cancelThrottle = exports.throttle = exports.callback = exports.setClientState = exports.redirect = exports.hide = exports.remove = exports.morph = void 0;
...
var translations = function translations(url) {
  _mousetrap.default.bind('mod+shift+1', function () {
    trans = !trans;
    ...
    if (trans) {
      document.querySelectorAll("body *").forEach(function (x) {
        ...
        if (x.textContent === x.innerHTML) {
          ...
          x.childNodes.forEach(function (y, i) {
      ...
      document.querySelectorAll(".hypergen-translating").forEach(function (x) {
        x.setAttribute("contenteditable", false);
        x.classList.remove("hypergen-translating");
      });
      document.querySelectorAll(".hypergen-unwrap-later").forEach(function (x) {
        var x2 = document.createTextNode(x.textContent);
  ...
  document.addEventListener('keydown', function (event) {
    ...
    if (event.key === "Escape") {
      ...
      event.stopPropagation();
      event.preventDefault();
      var _ref3 = [event.target.getAttribute("data-hypergen-original"), event.target.textContent],
          a = _ref3[0],
          b = _ref3[1];
