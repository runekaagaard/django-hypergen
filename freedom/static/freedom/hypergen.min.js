...
exports.element = exports.v = exports.link = exports.cancelThrottle = exports.throttle = exports.callback = exports.setEventHandlerCache = exports.morph = void 0;
...
var callback = function callback(url, args, kwargs) {
...
var link = function link() {}; // Internal


exports.link = link;

var parseArgs = function parseArgs(args, data) {
    ...
    if (typeof x === "function") {
      ...
      if (x.length === 3 && x[0] === "_") {
        if (x[1] === "element_value") {
          var func = resolvePath(x[2].cb_name);
...
window.e = function (targetId, dataId) {
  applyCommand.apply(void 0, _toConsumableArray(eventHandlerCache[targetId][dataId]));
};
...
var isDomEntity = function isDomEntity(entity) {
  return _typeof(entity) === 'object' && entity.nodeType !== undefined;
};
...
v.i = function (id) {
  var el = isDomEntity(id) ? (0, _jquery.default)(id) : (0, _jquery.default)("#" + id);
...
v.c = function (id) {
  var el = isDomEntity(id) ? (0, _jquery.default)(id) : document.getElementById(id);
  return el.checked;
};
...
v.r = function (id) {
  var el = isDomEntity(id) ? (0, _jquery.default)(id) : (0, _jquery.default)("#" + id);
  return "" + (0, _jquery.default)("input:radio[name ='" + el.attr("name") + "']:checked").val();
};
