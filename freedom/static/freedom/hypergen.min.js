...
},{"process":"../../../../../../../usr/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/morphdom/dist/morphdom-esm.js":[function(require,module,exports) {
"use strict";
...
exports.post = exports.element = exports.v = exports.cancelThrottle = exports.throttle = exports.callback = exports.setEventHandlerCache = exports.redirect = exports.hide = exports.remove = exports.morph = void 0;
...
var setEventHandlerCache = function setEventHandlerCache(id, newCache) {
...
exports.setEventHandlerCache = setEventHandlerCache;
var i = 0;
var isBlocked = false;
...
window.e = function (event, targetId, dataId, eventMatches) {
  ...
  applyCommand.apply(void 0, _toConsumableArray(window.eventHandlerCache[targetId][dataId]));
};
...
var MISSING_ELEMENT_EXCEPTION = "MISSING_ELEMENT_EXCEPTION"; // DOM element value readers
...
v.n = function (id) {
  // number. float or integer depending on value of step attribute.
  var el = document.getElementById(id);
  if (!el.step) return v.i(id);else if (el.step === "any") return v.f(id);else return Number.isInteger(parseFloat(el.step)) ? v.i(id) : v.f(id);
};
...
v.d = function (id) {
  ...
  if (!el.value) return null;else return {
    _: ["date", el.value]
  };
};
...
var element = function element(valueFunc, id) {
...
var post = function post(url, formData, onSuccess, onError, params) {
...
},{"jquery":"node_modules/jquery/dist/jquery.js","morphdom":"node_modules/morphdom/dist/morphdom-esm.js","./hypergen":"hypergen.js"}],"../../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
