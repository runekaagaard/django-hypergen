...
[...e.attributes].forEach(e=>{t.setAttribute(e.nodeName,e.nodeValue)}),t.innerHTML=e.innerHTML,e.replaceWith(t)}}});let o=document.querySelectorAll("[autofocus]")[0];void 0!==o&&o.focus()},w=function(e){let t=document.getElementById(e);t&&t.parentNode.removeChild(t)},N=function(e){document.getElementById(e).style.display="none"},C=function(e,t){document.getElementById(e).style.display=t||"block"},T=function(e,t){document.getElementById(e).style.visibility="visible"},S=function(e,t){document.getElementById(e).style.visibility="hidden"},A=function(e){/*
