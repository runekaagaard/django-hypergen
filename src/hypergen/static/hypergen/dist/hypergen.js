(()=>{function e(e,t,n,o){Object.defineProperty(e,t,{get:n,set:o,enumerable:!0,configurable:!0})}var t,n,o={};e(o,"morph",()=>b),e(o,"remove",()=>w),e(o,"hide",()=>N),e(o,"display",()=>C),e(o,"visible",()=>T),e(o,"hidden",()=>S),e(o,"redirect",()=>A),e(o,"append",()=>I),e(o,"prepend",()=>k),e(o,"setClientState",()=>O),e(o,"intervalSet",()=>R),e(o,"applyCommands",()=>z),e(o,"intervalClear",()=>x),e(o,"addEventListener",()=>B),e(o,"callback",()=>W),e(o,"keypressToCallback",()=>H),e(o,"keypressToCallbackRemove",()=>P),e(o,"throttle",()=>V),e(o,"partialLoad",()=>X),e(o,"onpushstate",()=>ea),e(o,"cancelThrottle",()=>G),e(o,"event",()=>K),e(o,"coerce",()=>Z),e(o,"read",()=>ee),e(o,"when",()=>et),e(o,"element",()=>en),e(o,"reviver",()=>eo),e(o,"ready",()=>ed);var r="undefined"==typeof document?void 0:document,l=!!r&&"content"in r.createElement("template"),i=!!r&&r.createRange&&"createContextualFragment"in r.createRange();/**
...
for(var a=i.length-1;a>=0;a--)o=(n=i[a]).name,r=n.namespaceURI,l=n.value,r?(o=n.localName||o,e.getAttributeNS(r,o)!==l&&("xmlns"===n.prefix&&(o=n.name),e.setAttributeNS(r,o,l))):e.getAttribute(o)!==l&&e.setAttribute(o,l);for(var d=e.attributes,u=d.length-1;u>=0;u--)o=(n=d[u]).name,(r=n.namespaceURI)?(o=n.localName||o,t.hasAttributeNS(r,o)||e.removeAttributeNS(r,o)):t.hasAttribute(o)||e.removeAttribute(o)}},function(e,o,d){if(d||(d={}),"string"==typeof o){if("#document"===e.nodeName||"HTML"===e.nodeName||"BODY"===e.nodeName){var f,p,m,h,v,g,y,E,b=o;(o=r.createElement("html")).innerHTML=b}else f=(f=o).trim(),o=l?(p=f,(m=r.createElement("template")).innerHTML=p,m.content.childNodes[0]):i?(h=f,n||(n=r.createRange()).selectNode(r.body),n.createContextualFragment(h).childNodes[0]):(v=f,(g=r.createElement("body")).innerHTML=v,g.childNodes[0])}var w=d.getNodeKey||s,N=d.onBeforeNodeAdded||c,C=d.onNodeAdded||c,T=d.onBeforeElUpdated||c,S=d.onElUpdated||c,A=d.onBeforeNodeDiscarded||c,I=d.onNodeDiscarded||c,k=d.onBeforeElChildrenUpdated||c,O=!0===d.childrenOnly,L=Object.create(null),R=[];function x(e){R.push(e)}/**
         ...
         * @return {undefined}
         */function B(e,t,n){!1!==A(e)&&(t&&t.removeChild(e),I(e),function e(t,n){if(1===t.nodeType)for(var o=t.firstChild;o;){var r=void 0;n&&(r=w(o))?// to a list so that it can be handled at the very end.
x(r):(// Only report the node as discarded if it is not keyed. We do this because
...
x(l)://       still a chance they will be matched up later
B(f,t,!0),f=c):// is no matching keyed node in the source tree
...
x(l)://       still a chance they will be matched up later
B(f,t,!0),f=i}// END: while(curFromNodeChild) {}
...
x(n)://       still a chance they will be matched up later
B(t,e,!0),t=o}}(t,f,l);var v=u[t.nodeName];v&&v(t,n)}// END: morphChildren(...)
(n,o):u.TEXTAREA(n,o))}(U,o,O),R)for(var P=0,D=R.length;P<D;P++){var M=L[R[P]];M&&B(M,M.parentNode,!1)}}return!O&&U!==e&&e.parentNode&&(U.actualize&&(U=U.actualize(e.ownerDocument||r)),// If we had to swap out the from node with a new node because the old
