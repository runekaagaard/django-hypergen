...
var _default = exports.default = morphdom;
...
exports.when = exports.visible = exports.throttle = exports.setClientState = exports.reviver = exports.remove = exports.redirect = exports.ready = exports.read = exports.prepend = exports.partialLoad = exports.onpushstate = exports.morph = exports.keypressToCallbackRemove = exports.keypressToCallback = exports.intervalSet = exports.intervalClear = exports.hide = exports.hidden = exports.event = exports.element = exports.display = exports.coerce = exports.cancelThrottle = exports.callback = exports.applyCommands = exports.append = exports.addEventListener = void 0;
...
var morph = exports.morph = function morph(id, html) {
...
var hide = exports.hide = function hide(id) {
  var el = document.getElementById(id);
  el.style.display = "none";
};
var display = exports.display = function display(id, value) {
  var el = document.getElementById(id);
  el.style.display = value || "block";
};
var visible = exports.visible = function visible(id, value) {
  var el = document.getElementById(id);
  el.style.visibility = "visible";
};
var hidden = exports.hidden = function hidden(id, value) {
  var el = document.getElementById(id);
  el.style.visibility = "hidden";
};
var redirect = exports.redirect = function redirect(url) {
  window.location = url;
};
var append = exports.append = function append(id, html) {
  var el = document.getElementById(id);
  if (!el) console.error("Cannot append to missing element", id);
  el.innerHTML += html;
};
var prepend = exports.prepend = function prepend(id, html) {
  var el = document.getElementById(id);
  if (!el) console.error("Cannot prepend to missing element", id);
  el.innerHTML = html + el.innerHTML;
};
hypergen.clientState = {};
var setClientState = exports.setClientState = function setClientState(at, value) {
...
/* WARNING NOT STABLE */
var INTERVALS = {};
var intervalSet = exports.intervalSet = function intervalSet(commands, interval, name) {
  var i = setInterval(function () {
    return applyCommands(commands);
  }, interval);
  if (!!name) INTERVALS[name] = i;
};
var intervalClear = exports.intervalClear = function intervalClear(name) {
  if (INTERVALS[name]) {
    console.log("Clearing", INTERVALS[name]);
    clearInterval(INTERVALS[name]);
  }
};
var addEventListener = exports.addEventListener = function addEventListener(querySelectorString, type, commands, options) {
  document.querySelector(querySelectorString).addEventListener(type, function (event) {
    return applyCommands(commands);
  }, options || {});
};
var _TTT = {};
var keypressToCallbackFunc = function keypressToCallbackFunc(e) {
  var _TTT2 = _TTT,
    _TTT3 = _slicedToArray(_TTT2, 3),
    url = _TTT3[0],
    args = _TTT3[1],
    options = _TTT3[2];
  callback(url, [e.key].concat(_toConsumableArray(args || [])), options || {});
};
var keypressToCallback = exports.keypressToCallback = function keypressToCallback(url, args, options) {
  _TTT = [url, args, options];
  window.addEventListener("keydown", keypressToCallbackFunc);
};
var keypressToCallbackRemove = exports.keypressToCallbackRemove = function keypressToCallbackRemove(url, args, options) {
...
var i = 0;
var isBlocked = false;
var callback = exports.callback = function callback(url, args) {
...
var partialLoad = exports.partialLoad = function partialLoad(event, url, pushState) {
...
var throttle = exports.throttle = function throttle(func) {
...
var cancelThrottle = exports.cancelThrottle = function cancelThrottle(group) {
  if (_THROTTLE_GROUPS[group]) {
    clearTimeout(_THROTTLE_GROUPS[group]);
    _THROTTLE_GROUPS[group] = null;
  }
...
var event = exports.event = function event(_event, callbackKey, when) {
...
var applyCommands = exports.applyCommands = function applyCommands(commands) {
...
var MISSING_ELEMENT_EXCEPTION = "MISSING_ELEMENT_EXCEPTION";
...
var element = exports.element = function element(valueFunc, coerceFunc, id) {
...
var reviver = exports.reviver = function reviver(k, v) {
  if (Array.isArray(v)) {
    if (v.length === 3 && v[0] === "_") {
...
function addParams(url, params) {
  var ret = [];
  for (var d in params) ret.push(encodeURIComponent(d) + '=' + encodeURIComponent(params[d]));
...
var onpushstate = exports.onpushstate = function onpushstate() {
...
},{"morphdom":"../node_modules/morphdom/dist/morphdom-esm.js","./hypergen":"hypergen.js"}],"../../../../../../../../../usr/local/share/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../../../usr/local/share/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","hypergen.js"], null)
