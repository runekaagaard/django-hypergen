...
var keypressToCallback = function keypressToCallback(url, args, options) {
  window.addEventListener("keydown", function (e) {
    console.log();
    callback(url, [e.key].concat(_toConsumableArray(args || [])), options || options);
  });
};
