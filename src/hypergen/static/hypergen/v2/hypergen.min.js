...
var intervalSet = function intervalSet(commands, interval, name) {
...
var intervalClear = function intervalClear(name) {
  if (INTERVALS[name]) {
...
exports.intervalClear = intervalClear;

var addEventListener = function addEventListener(querySelectorString, type, commands, options) {
...
var keypressToCallback = function keypressToCallback(url, args, options) {
  _TTT = [url, args, options];
  window.addEventListener("keydown", keypressToCallbackFunc);
};

exports.keypressToCallback = keypressToCallback;

var keypressToCallbackRemove = function keypressToCallbackRemove(url, args, options) {
...
exports.keypressToCallbackRemove = keypressToCallbackRemove;
var i = 0;
var isBlocked = false;
